...
import de.clearit.test.framework.listener.ScreenShotOnFailure;
import de.clearit.test.framework.listener.DriverCleanUpOnTestFinished;

public class AllTestListenerAdapters extends AllTestBasisListenerAdapters {

	// Logger
	private static Logger LOGGER = Logger.getLogger(AllTestListenerAdapters.class.getName());
	 ...
	 * 
	 */
	public AllTestListenerAdapters() {
		testListenerAdapter.add(new ScreenShotOnFailure());
		testListenerAdapter.add(new DriverCleanUpOnTestFinished());
	}
