...
final public class ErrorBoxUtil {
	 ...
	 */
	public static String holeAktuellenErrorText(WindowsDriver<WebElement> driver, long timeoutInSekunden) {
	...
	private static String getTextOrNull(WebDriver driver, long timeoutInSekunden) {
		// Hier auf keinen Fall GuiElement verwenden, sonst gibt es
		// endlosschleifen, denn das GuiElement erzeugt intern
