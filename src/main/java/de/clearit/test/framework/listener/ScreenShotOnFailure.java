...
public class ScreenShotOnFailure extends BaseProjectTestListenerAdapter {
	...
	private void takeScreenshotFromWebdriver(final ITestResult tr) {
		final WindowsDriver<WebElement> driver = ((DriverHolder) tr.getInstance()).getWinDriver();
		if (driver != null) {
	...
	private void takeScreenshot(final ITestResult tr, final WindowsDriver<WebElement> driver) {
